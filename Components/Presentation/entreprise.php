...
<head>
    ...
    <style></style>
    <link rel="stylesheet" href="../../style/presentation_ent.css">
...
<body>
    ...
    <main>
                        ...
                        foreach ($pj as $row) {
                            ...
                            if ($row["type"] == "document") {
                                ...
                                echo "<div class='part p2'>
                                            ...
                                            <p>$row[description]</p>
                                            <br>
                                            <a href='../../public/entreprises/piece_jointe/documents/$row[element]' >Ouvrir le document &#8594;</a>
                                            <br><br>
                                        </div>";
                            }
                        }
        ...
        <div class="container" id="container">
            ...
            <div class="popform">
                ...
                <form method="POST" id="form_img" action="../../api/entreprise/add_piece_jointe_image.php" enctype="multipart/form-data">
        ...
        <div class="container" id="form_doc">
            <div class="popform">
                ...
                <form class="form_doc" method="POST" action="../../api/entreprise/add_piece_jointe_document.php" enctype="multipart/form-data">
                    <input type="hidden" name="id_ent" value="<?php echo $ent['id']; ?>">
                    <div class="champ">
        ...
        <div class="opp">
            ...
            <a href="../../api/entreprise/delete_ent.php?id_ent=<?php echo $_GET['id_ent']; ?>" class="delete">Supprimer
        ...
        <div class="form_edit" id="form_edit">
            ...
            <form action="../../api/entreprise/update_ent.php" method="post" class="form_content" enctype="multipart/form-data">
        ...
        <div id="edit_image_entreprise">
            <form action="../../api/entreprise/edit_image_entreprise.php" method="post" enctype="multipart/form-data" style="background-color: #fff; padding:20px; border-radius: 5px;">
    ...
    include("../footer.html");
    ?>
    <script src="../../script/presentation_ent.js"></script>
</body>
